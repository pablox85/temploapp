...
export default async function MyItemsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl">
      <header className="mb-8"><p className="text-sm font-semibold text-teal-600">TU SELECCIÓN</p><h1 className="mt-1 text-3xl font-bold tracking-tight text-slate-950">Mi ítem</h1><p className="mt-2 text-slate-500">Administra el ítem que elegiste. Solo tú puedes liberarlo.</p></header>
